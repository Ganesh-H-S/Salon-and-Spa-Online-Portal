...
<body id="home" class="scrollspy">
      ...
      <div class="row">
        <div class="col s12 m6">
          ...
          <ul class="collection with-header">
            ...
            <li class="collection-item">Udupi Garden</li>
            <li class="collection-item">BTM Layout, Bengaluru, Karnataka 560076</li>
            <li class="collection-item">Timings: 9:30a.m-7.00p.m</li>  
            <li class="collection-item">&#9742;          7259698925, 9844119965</li>
         </ul>
        </div>
  ...
  <footer class="section pink darken-2 white-text center">
      <p class="flow-text"><H4>Salon and Spa  &copy; 2020 </H4></p>
  </footer>
